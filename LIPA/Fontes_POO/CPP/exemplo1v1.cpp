...
class Aluno
{
  ...
  public:
    void poeNome(const std::string &nome) //Usar o CONST no procedimento de ponteiro (&nome) por mais que seja um procedimento por referencia ele nao retorna por causa do const
    {
      this->nome = nome;
    }
